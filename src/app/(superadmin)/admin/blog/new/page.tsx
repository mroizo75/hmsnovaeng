...
import { ArrowLeft, Save, Eye, Loader2, X, Copy } from "lucide-react";
...
export default function NewBlogPostPage() {
  ...
  const [formData, setFormData] = useState({
    ...
    content: "",
    coverImage: "",
    coverImageKey: "", // R2 key for deletion
    metaTitle: "",
    metaDescription: "",
    keywords: "",
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!res.ok) throw new Error("Kunne ikke opprette artikkel");

      const post = await res.json();
      toast({
        title: "Artikkel opprettet!",
        description: "Din artikkel er nå lagret",
      });
      ...
      toast({
        title: "Feil!",
        description: "Kunne ikke opprette artikkel",
        variant: "destructive",
      });
    } finally {
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-muted-foreground">
              Skriv en ny HMS-artikkel for bedre SEO
            </p>
          </div>
        </div>
